...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
    ...
    CTL_TAB, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,                        KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    CTL_QUO,
    ...
    [_UD_L] = LAYOUT(
      RESET, _______,    LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), _______,                   _______, _______, _______, _______, _______, _______,
    ...
    [_UD_R] = LAYOUT(
      _______, _______, _______, _______, _______, _______,                   _______, RGUI(KC_7), RGUI(KC_8), RGUI(KC_9), KC_PAST, _______,
      _______, _______, _______, _______, _______, _______,                   _______, RGUI(KC_4), RGUI(KC_5), RGUI(KC_6), KC_EQL,  RESET,
    ...
    [_SM_L] = LAYOUT(
      ...
      _______, UC(952), UC(969), UC(966), UC(960), UC(946),                   _______, _______, _______, _______, _______, RESET,
    ...
    [_SM_R] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,                   UC(958), UC(955), _______, UC(968), UC(177), RESET,
    ...
    [_SMSL] = LAYOUT(
      ...
      UC(65103), UC(920), UC(937), UC(934), UC(928), UC(914),                 _______, _______, _______, _______, _______, RESET,
    ...
    [_SMSR] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,                   UC(926), UC(923), _______, UC(936), UC(8757), RESET,
