...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(  /* Colemak_dh= */
    ...
    KC_LCTL, KC_LGUI, KC_LALT, SYM_BSP, EXT_L,   THMB_DL, THMB_UL,   THMB_UR, THMB_DR, EXT_R,   SYM_DEL, ALT_DWN, GUI_UP,  CTL_RHT
  ),
  ...
  [_UP_L] = LAYOUT(
    ...
    _______, KC_BSLS, KC_0,  KC_COMM, KC_DOT,    KC_LABK,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, MO(_UD_L), _______, _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_UP_R] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   KC_RABK, KC_0,    _______, _______, KC_BSLS, _______,
    _______, _______, _______, _______, _______, _______, _______,  _______, MO(_UD_R), _______, _______, _______, _______, _______
  ),
  ...
  [_DN_L] = LAYOUT(
    ...
    _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  MO(_ED_L),                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, MO(_UD_L), _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_DN_R] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   MO(_ED_R), KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______,
    _______, _______, _______, _______, _______, _______, _______, MO(_UD_R), _______, _______, _______, _______, _______, _______
  ),
  ...
  [_EX_L] = LAYOUT(
    ...
    _______, LCTL(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_D), MO(_ED_L),                   _______, _______, _______, _______, _______, _______,
    _______, _______,    _______,    _______, _______,  MO(_ED_L), _______,   _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_EX_R] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, MO(_ED_R), _______, _______, _______, _______, _______
  ),

  [_UD_L] = LAYOUT(
    LGUI(KC_Q), _______,    LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), _______,                   _______, _______, _______, _______, _______, RESET,
    LGUI(KC_GRV),   (KC_Q), LGUI(KC_4), LGUI(KC_5), LGUI(KC_6), LGUI(KC_B),           _______, _______, _______, _______, _______, _______,
    _______, LCTL(KC_A), LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), _______,                   _______, _______, _______, _______, _______, _______,
    _______, LCTL(KC_Z), LGUI(KC_0), LGUI(KC_C), LGUI(KC_D), _______,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, MO(_UD_L), MO(_UD_L), _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_UD_R] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   _______, RGUI(KC_0), RGUI(KC_C), RGUI(KC_D), KC_BSLS, _______,
    _______, _______, _______, _______, _______, _______, _______, MO(_UD_R), MO(_UD_R), _______, _______, _______, _______, _______
  ),
  ...
  [_ED_L] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, MO(_ED_L), MO(_ED_L), _______, _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_ED_R] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, MO(_ED_R), MO(_ED_R), _______, _______, _______, _______
  ),
  ...
  [_SM_L] = LAYOUT(
    ...
    MO(_ED_L), UC(950), UC(967), UC(162), UC(948), UC(8711),                _______, _______, _______, _______, _______, MO(_ED_L),
    _______, _______, _______, _______, _______, MO(_ED_L), _______, _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_SM_R] = LAYOUT(
    ...
    MO(_SMSR), _______, _______, _______, _______, _______,                   UC(922), UC(951), UC(8804), UC(8805), UC(247), MO(_SMSR),
    _______, _______, _______, _______, _______, _______, _______, _______, MO(_ED_R), _______, _______, _______, _______, _______
  ),
