...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_UP_R] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   KC_ACL0, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
    _______, _______, _______, _______, _______, KC_LGUI, THUMB_B, _______, KC_RGUI, _______, _______, _______, _______, _______
  ),
  ...
  [_UP_L] = LAYOUT(
    ...
    _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_ACL2,                   _______, _______, _______, _______, _______, _______,
