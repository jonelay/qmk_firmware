...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( /* Colemak= */
    ...
    KC_LCTL, KC_LGUI, KC_LALT, EXT_L,   SFT_BSP, HOME_L,  THUMB_L, THUMB_R, HOME_R,  SFT_DEL, EXT_R,  ALT_DWN,  GUI_UP, CTL_RHT
  ),
  ...
  [_DN_R] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   KC_RGUI, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
  ...
  [_DN_L] = LAYOUT(
    ...
    _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_LGUI,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, THUMB_B, _______, _______, _______, _______, _______, _______
  ),

  [_DN_B] = LAYOUT(
    RESET, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_MUTE,
    _______, _______, _______, UC(9785), KC_PSCR, UC(8226),                   KC_PAUS, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,
  ...
  [_DN_SB] = LAYOUT(
    RESET, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_MUTE,
    _______, _______, _______, _______, _______, UC(9702),                   _______, _______, _______, _______, _______, _______,
  ...
  [_UP_R] = LAYOUT(
    RESET, _______, _______, _______, _______, _______,                   KC_RCBR, KC_7,    KC_8,    KC_9,    KC_PAST, _______,
  ...
  [_UP_L] = LAYOUT(
    RESET, KC_PAST, KC_9,    KC_8,    KC_7,    KC_LCBR,                   _______, _______, _______, _______, _______, _______,
    _______, KC_EQL,  KC_6,    KC_5,    KC_4,    KC_LBRC,                   _______, _______, _______, _______, _______, _______,
    _______, KC_MINS, KC_3,    KC_2,    KC_1,    KC_LPRN,                   _______, _______, _______, _______, _______, _______,
    _______, KC_BSLS, KC_DOT,  KC_COMM, KC_0,    KC_LABK,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, HOME_B,  _______, _______, _______, _______, _______
  ),

  [_UP_B] = LAYOUT(
    RESET, UC(8543), UC(189), UC(8531), UC(188), UC(8533),                   UC(8537), UC(8528), UC(8539), UC(8529), UC(8530), _______,
    _______, UC(952), UC(969), UC(966), UC(960), UC(946),                   UC(958), UC(955), _______, UC(968), UC(177), _______,
  ...
  [_UP_SB] = LAYOUT(
    RESET, UC(8265), UC(178), UC(179), UC(163), UC(8733),                   UC(8743), _______, _______, UC(11816), UC(11817), _______,
    UC(65103), UC(920), UC(937), UC(934), UC(928), UC(914),                   UC(926), UC(923), _______, UC(936), UC(8757), _______,
  ...
  [_EXTR] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                   KC_HYPR, KC_RCTL, KC_RGUI, KC_RSFT, KC_RALT, _______,
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
